...
total_size = 0
s_codezcount = {200: 0, 301: 0, 400: 0, 401: 0, 403: 0, 404: 0, 405: 0, 500: 0}
line_count = 0
...
def print_statistics():
    ...
    for status_code in sorted(s_codezcount):
        count = s_codezcount[status_code]
        if count > 0:
...
try:
    for line in sys.stdin:
	    ...
	    """Update total file size and status code counts"""
            ...
            if status_code in s_codezcount:
                s_codezcpont[status_code] += 1
